...
const Login = () => {
  ...
  return (
    <div className="container flex justify-around  w-screen h-screen bg-[#efecef]">
      ...
      <div className="flex items-center  flex-col w-1/3  m-auto mr-36  border-gray-400 border shadow-lg bg-white mt-20 rounded-2xl">
        <h2 className="font-bold text-2xl bg-blue-500 w-full text-white flex justify-center  h-10 px-4 rounded-tl-2xl rounded-tr-2xl">Login</h2>
        <Form className=" w-full" onSubmit={handleLogin} ref={form}>
          ...
          <div className="px-4 py-4 flex flex-col gap-2 items-center">
            <button
              className="outline outline-2 outline-orange-500 hover:bg-orange-600 hover:text-white font-bold w-32 py-3 px-4  rounded-md text-lg"
              disabled={loading}
            >
              {loading && <span></span>}
              <span>Login</span>
